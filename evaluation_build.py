...
<main><p class="eyebrow">AssemblyAI · Recorded fixture evaluation · September 20, 2026</p><h1>Hear the test.<br>Inspect the evidence.</h1>
...
<div class="notice">A completed transport is not complete policy coverage. Detector findings need contextual review; digit mentions do not verify identity. Audio records successful local WebSocket sends, not provider receipt. Provider transcripts may include generated audio that never reached the peer; inspect the per-reply byte counts and delivered tracks. Missing or unobserved test conditions remain explicit.</div>
